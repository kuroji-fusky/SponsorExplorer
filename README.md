...
A modern rewrite of Lanrza's [SBBrowser][sbb] and with more features and a more fancy and intuitive UI!
...
1. Search for "youtube data api", and you'll see a result for "YouTube Data API v3" enable it
